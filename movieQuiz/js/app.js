...
xhr.onreadystatechange = function() {
    if (xhr.readyState === 4) //4 är när servern har svarat. Readystate är objektets stadie som det är i.
    {
        ...
        romanceButton.addEventListener("click", chooseGenre);
        comedyButton.addEventListener("click", chooseGenre);
        ...
        function movieGame() {
            ...
            if (gameInterval < 5) {
                ...
                if (randomMovie.genre == chosenGenre) {
